      ...
      <PageSEO
        ...
        jsonLd={[
          ...
          },
          {
            ...
            thumbnailUrl: 'https://www.pfandco.co.uk/videos/bng-screening-thumb.jpg',
      ...
      <section className="py-32 bg-brand-surface">
        <div className="max-w-7xl mx-auto px-6">
          <ComparisonTable 
            ...
            footerNote="Comparison based on typical UK ecology consultancy practices. PF&Co BNG Screening pulls data from 60 authoritative sources and references the latest Environment Act 2021 statutory guidance."
