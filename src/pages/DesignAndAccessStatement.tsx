        ...
        <div className="bg-indigo-600 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-600/20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <button className="px-12 py-6 bg-indigo-700/50 backdrop-blur-md text-white border border-white/20 rounded-full font-bold hover:bg-indigo-800/50 transition-all flex items-center gap-2">
