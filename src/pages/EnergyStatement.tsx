        ...
        <div className="bg-amber-600 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-amber-600/20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <button className="px-12 py-6 bg-amber-700/50 backdrop-blur-md text-white border border-white/20 rounded-full font-bold hover:bg-white/80 transition-all flex items-center gap-2">
