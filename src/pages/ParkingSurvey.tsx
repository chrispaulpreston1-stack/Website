  ...
  return (
    <div className="pt-20">
            ...
            <div className="aspect-[4/5] bg-white/5 backdrop-blur-xl rounded-[4rem] border border-white/10 p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-white/40">Provision Status</div>
              ...
              <div className="relative z-10 pt-8 border-t border-white/10 flex justify-between items-end">
                <div>
                  ...
                  <div className="text-lg font-bold">Sustainable Hub <span className="text-xs font-normal opacity-40">(Low Car Need)</span></div>
                </div>
      ...
      <VideoExplainer 
        ...
        description="Watch our walkthrough to see how we use granular Census data and accessibility mapping to justify reduced parking provision, helping you overcome one of the most common grounds for planning refusal."
        thumbnailUrl="https://picsum.photos/seed/parking/1280/720"
        duration="3:20"
      />
      ...
      <section className="py-32 bg-brand-surface">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-16 text-center font-accent italic text-brand-primary text-rose-600">Common Inquiries</h2>
