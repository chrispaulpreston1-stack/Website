  ...
  return (
    <div className="pt-20">
          ...
          >
            <div className="aspect-[4/5] bg-white/5 backdrop-blur-xl rounded-[4rem] border border-white/10 p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-white/40">Heritage Status</div>
              ...
              <div className="relative z-10 pt-8 border-t border-white/10 flex justify-between items-end">
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-widest text-white/40 mb-1">Designation Context</div>
                  <div className="text-lg font-bold">Grade II Listed <span className="text-xs font-normal opacity-40">(Medium Sensitivity)</span></div>
                </div>
      ...
      <VideoExplainer 
        ...
        description="Watch our walkthrough to see how we apply the HEAN 12 four-interest framework and NPPF heritage balance tests, helping you navigate conservation officer expectations."
        thumbnailUrl="https://picsum.photos/seed/heritage/1280/720"
        duration="3:50"
      />
