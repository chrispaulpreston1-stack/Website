...
const PreConstructionDesignReview = () => {
  const report = getReportBySlug('pre-construction-design-review')!;
  const features = [
      ...
      <PageSEO
        ...
        jsonLd={[
          ...
          },
          {
            ...
            thumbnailUrl: 'https://www.pfandco.co.uk/videos/design-review-thumb.jpg',
            contentUrl: 'https://www.pfandco.co.uk/videos/design-review-demo.mp4',
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
          ...
          >
            ...
            <div className="flex flex-wrap gap-6 items-center">
              ...
              <a href="/samples/pre-construction-design-review-sample.pdf" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-full font-bold hover:bg-white/20 transition-all flex items-center gap-2">
          ...
          >
            <div className="aspect-[4/5] bg-white/5 backdrop-blur-xl rounded-[4rem] border border-white/10 p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-white/60">Package Status</div>
              ...
              <div className="relative z-10 pt-8 border-t border-white/10 flex justify-between items-end">
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-widest text-white/60 mb-1">Review Context</div>
                  <div className="text-lg font-bold">Pre-Tender <span className="text-xs font-normal opacity-60">(Variation Mitigation)</span></div>
                </div>
        ...
        <div className="bg-rose-600 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-rose-600/20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <a href="/samples/pre-construction-design-review-sample.pdf" target="_blank" rel="noopener noreferrer" className="px-12 py-6 bg-rose-700/50 backdrop-blur-md text-white border border-white/20 rounded-full font-bold hover:bg-rose-800/50 transition-all flex items-center gap-2">
