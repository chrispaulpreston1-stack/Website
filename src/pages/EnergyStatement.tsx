      ...
      <section className="py-32 bg-brand-surface">
        <div className="max-w-7xl mx-auto px-6">
          <ComparisonTable 
            ...
            footerNote="Comparison based on typical UK sustainability consultancy practices. PF&Co Energy Statement pulls data from 44 authoritative sources and references the latest Part L 2021 and Part O 2021 requirements."
