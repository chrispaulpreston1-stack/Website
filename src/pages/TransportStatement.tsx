      ...
      <section className="py-32 bg-brand-surface">
        <div className="max-w-7xl mx-auto px-6">
          <ComparisonTable 
            ...
            footerNote="Comparison based on typical UK transport consultancy practices. PF&Co Transport Statement pulls data from 15+ authoritative sources and uses TRICS for standardised trip generation."
        ...
        <div className="bg-blue-600 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-blue-600/20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <button className="px-12 py-6 bg-blue-700/50 backdrop-blur-md text-white border border-white/20 rounded-full font-bold hover:bg-blue-800/50 transition-all flex items-center gap-2">
