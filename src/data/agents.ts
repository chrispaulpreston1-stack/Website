...
export const agents: Agent[] = [
  ...
  { id: '14', name: 'Contamination Screener', role: 'Historic land use, contamination indicators', category: 'data-acquisition', triggeredBy: ['GDS', 'SFR', 'CFS', 'SAI', 'CMP'] },
  ...
  { id: '21', name: 'Mining Risk Assessor', role: 'Coal Authority data, historic mining activity', category: 'data-acquisition', triggeredBy: ['SFR', 'GDS', 'CFS', 'SAI'] },
  ...
  { id: '26', name: 'Planning Friction Scorer', role: '0-100 friction score with traffic-light rating', category: 'analysis-scoring', triggeredBy: ['SFR', 'PS', 'PAA', 'CFS', 'SAI'] },
  { id: '27', name: 'Buildability Rater', role: '1-10 buildability difficulty/cost impact score', category: 'analysis-scoring', triggeredBy: ['SFR', 'CFS', 'SAI', 'CMP', 'DRR'] },
  ...
  { id: '33', name: 'CIL Liability Calculator', role: 'CIL payment calculation, exemption checks', category: 'analysis-scoring', triggeredBy: ['CIL', 'CFS', 'SAI', 'PS'] },
  ...
  { id: '42', name: 'Infrastructure Impact Scorer', role: 'Calculates per-item property value impact using distance decay formulas and academic evidence base', category: 'market-intelligence', triggeredBy: ['SFR', 'CFS', 'SAI'] },
  { id: '43', name: 'Land Registry Benchmark Analyst', role: 'Pulls postcode sector, district, and regional price trends for before/after comparison', category: 'market-intelligence', triggeredBy: ['SFR', 'CFS', 'SAI'] },
  ...
  { id: '46', name: 'Comparative Market Analyst', role: 'Analyses local transaction data to quantify infrastructure event impact vs control areas', category: 'market-intelligence', triggeredBy: ['SFR', 'CFS', 'SAI'] },
  ...
  { id: '107', name: 'Development Viability Assessor', role: 'Residual land value, GDV, BCIS costs, viability screening', category: 'market-intelligence', triggeredBy: ['CFS', 'SAI', 'PS', 'CIL', 'PAA'] },
