      ...
      <PageSEO
        ...
        jsonLd={[
          ...
          },
          {
            ...
            thumbnailUrl: 'https://www.pfandco.co.uk/videos/das-demo-thumb.jpg',
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-16 p-12 bg-brand-primary rounded-[3rem] text-white relative overflow-hidden">
                ...
                <h3 className="text-3xl font-bold mb-6 relative z-10">48hr Turnaround <br /><span className="text-indigo-400 italic font-accent font-light">Typical.</span></h3>
