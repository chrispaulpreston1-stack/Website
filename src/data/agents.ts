...
export const agents: Agent[] = [
  ...
  { id: '01', name: 'Planning Constraint Screener', role: 'Conservation areas, Green Belt, AONB, Article 4, TPOs', category: 'data-acquisition', triggeredBy: ['SFR', 'PS', 'PAA', 'DAS', 'CFS'] },
  ...
  { id: '03', name: 'Use Class Classifier', role: 'Current & proposed use class determination', category: 'data-acquisition', triggeredBy: ['SFR', 'PS', 'PAA', 'CFS', 'CIL'] },
  { id: '04', name: 'Flood Zone Mapper', role: 'EA flood zone classification (fluvial, tidal)', category: 'data-acquisition', triggeredBy: ['SFR', 'FRA', 'CFS', 'DAS', 'PS'] },
  ...
  { id: '11', name: 'SuDS Viability Assessor', role: 'IH124 runoff rates, FEH cross-check, infiltration viability', category: 'data-acquisition', triggeredBy: ['FRA', 'DAS', 'CFS', 'CMP'] },
  ...
  { id: '14', name: 'Contamination Screener', role: 'Historic land use, contamination indicators', category: 'data-acquisition', triggeredBy: ['GDS', 'SFR', 'CFS', 'CMP'] },
  ...
  { id: '20', name: 'UXO Risk Screener', role: 'Unexploded ordnance risk assessment', category: 'data-acquisition', triggeredBy: ['SFR', 'GDS', 'CMP'] },
  { id: '21', name: 'Mining Risk Assessor', role: 'Coal Authority data, historic mining activity', category: 'data-acquisition', triggeredBy: ['SFR', 'GDS', 'CFS'] },
  { id: '22', name: 'EPC & Energy Analyst', role: 'EPC register lookup, MEES compliance', category: 'data-acquisition', triggeredBy: ['SFR', 'ES', 'CFS', 'DRR'] },
  ...
  { id: '26', name: 'Planning Friction Scorer', role: '0-100 friction score with traffic-light rating', category: 'analysis-scoring', triggeredBy: ['SFR', 'PS', 'PAA', 'CFS'] },
  { id: '27', name: 'Buildability Rater', role: '1-10 buildability difficulty/cost impact score', category: 'analysis-scoring', triggeredBy: ['SFR', 'CFS', 'CMP', 'DRR'] },
  ...
  { id: '29', name: 'Sequential Test Assessor', role: 'Flood zone sequential/exception test compliance', category: 'analysis-scoring', triggeredBy: ['FRA', 'PS', 'CFS'] },
  ...
  { id: '33', name: 'CIL Liability Calculator', role: 'CIL payment calculation, exemption checks', category: 'analysis-scoring', triggeredBy: ['CIL', 'CFS', 'PS'] },
  ...
  { id: '40', name: 'Asbestos Risk Indicator', role: 'Age-based asbestos probability screening', category: 'analysis-scoring', triggeredBy: ['SFR', 'CMP', 'GDS', 'DRR'] },
  ...
  { id: '85', name: 'Daylight & Sunlight Assessor', role: 'BRE 209 daylight/sunlight impact assessment (VSC, APSH, NSL)', category: 'analysis-scoring', triggeredBy: ['DAS', 'PS', 'PAA'] },
  ...
  { id: '88', name: 'Noise Impact Assessor', role: 'BS 4142/BS 8233/ProPG noise screening and impact assessment', category: 'analysis-scoring', triggeredBy: ['PS', 'DAS', 'PAA', 'CMP'] },
  ...
  { id: '92', name: 'EIA Screening Assessor', role: 'Schedule 1/2 EIA threshold screening', category: 'analysis-scoring', triggeredBy: ['SFR', 'PS', 'PAA', 'CFS'] },
  { id: '93', name: 'S106 Obligations Analyst', role: 'Predicted S106 heads of terms and contribution estimates', category: 'analysis-scoring', triggeredBy: ['PS', 'CFS', 'CIL', 'PAA'] },
  ...
  { id: '97', name: 'Utilities Capacity Screener', role: 'DNO electricity, water/sewer capacity, broadband, EV charging', category: 'data-acquisition', triggeredBy: ['SFR', 'CFS', 'ES', 'DRR', 'CMP'] },
  ...
  { id: '99', name: 'Air Quality Screener', role: 'AQMA proximity, IAQM/EPUK screening, construction dust risk', category: 'data-acquisition', triggeredBy: ['PS', 'DAS', 'CMP', 'SFR'] },
  ...
  { id: '101', name: 'Planning Policy Compliance Assessor', role: 'Development plan mapping, planning balance, tilted balance', category: 'analysis-scoring', triggeredBy: ['PS', 'PAA', 'SFR', 'DAS', 'CFS'] },
  ...
  { id: '103', name: 'Drainage Strategy Designer', role: 'SuDS hierarchy, foul drainage feasibility, attenuation design', category: 'analysis-scoring', triggeredBy: ['FRA', 'DAS', 'CFS', 'CMP'] },
  { id: '104', name: 'Open Space & Amenity Calculator', role: 'Private/public amenity space provision per FIT/LPA standards', category: 'analysis-scoring', triggeredBy: ['DAS', 'PS', 'PAA', 'CFS'] },
  ...
  { id: '107', name: 'Development Viability Assessor', role: 'Residual land value, GDV, BCIS costs, viability screening', category: 'market-intelligence', triggeredBy: ['CFS', 'PS', 'CIL', 'PAA'] },
  ...
  { id: '109', name: 'Transport Accessibility Scorer', role: 'Calculates nationwide PTAL-equivalent score from NaPTAN stop locations, BODS bus timetables, and National Rail service frequencies', category: 'data-acquisition', triggeredBy: ['TS', 'SFR', 'DAS', 'PKS', 'CFS', 'PAA', 'PS'] },
  { id: '110', name: 'Amenity Proximity Engine', role: 'Measures walking distances to nearest schools, GP surgeries, pharmacies, supermarkets, and convenience stores with RAG ratings against NPPF sustainability thresholds', category: 'data-acquisition', triggeredBy: ['SFR', 'CFS', 'PS', 'DAS', 'PAA'] },
  { id: '111', name: 'Grid Capacity Assessor', role: 'Queries DNO open data portals to assess electricity substation headroom, heat pump/EV charging capacity, and connection feasibility', category: 'data-acquisition', triggeredBy: ['ES', 'SFR', 'CFS', 'DRR', 'CMP', 'DAS'] },
  { id: '112', name: 'Market Data Enricher', role: 'Cross-references UK House Price Index trends with EPC floor areas and Land Registry transactions to calculate local price-per-sqft and market direction', category: 'market-intelligence', triggeredBy: ['CFS', 'SFR', 'PS', 'PAA', 'CIL'] },
];
