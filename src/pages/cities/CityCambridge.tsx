...
{/*  Hero  */}
<section className="sic-hero" style={{ backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.6), rgba(15, 23, 42, 0.8)), url('/images/cambridge_city_hero.png')` }} aria-label="Site Intelligence Reports in Cambridge">
