    ...
    <div className="pt-20">
            ...
            <div className="flex flex-wrap gap-6 items-center">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-white/60 line-through">RRP £475</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="aspect-[4/5] bg-white/5 backdrop-blur-xl rounded-[4rem] border border-white/10 p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-white/60">Statutory Status</div>
              ...
              <div className="relative z-10 pt-8 border-t border-white/10 flex justify-between items-end">
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-widest text-white/60 mb-1">Context Analysis</div>
                  <div className="text-lg font-bold">Conservation Area <span className="text-xs font-normal opacity-60">(High Sensitivity)</span></div>
                </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-16 p-12 bg-brand-primary rounded-[3rem] text-white relative overflow-hidden">
                ...
                <h3 className="text-3xl font-bold mb-6 relative z-10">48hr Turnaround <br /><span className="text-indigo-400 italic font-accent font-light">Guaranteed.</span></h3>
      ...
      <section className="py-32 bg-brand-surface">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-16 text-center font-accent italic text-indigo-600">Common Inquiries</h2>
